import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{c as D,T as we}from"./index-9OixZ9d5.js";import{r as _}from"./index-DZ_CqB28.js";import{F as Pe}from"./index.es-p5E9qsd2.js";import{b as qe,c as Me}from"./index-hpMfE_xg.js";import{T as ke}from"./index-DGVQz28I.js";import{B as Ie}from"./index-DWEzSuIy.js";import"./_commonjsHelpers-Cpj98o6Y.js";const Le="_inner_ujus9_119",Ce="_toggled_ujus9_142",Ee="_disabled_ujus9_178",Ve="_checkbox_ujus9_185",r={this:"_this_ujus9_99",inner:Le,toggled:Ce,"level-primary":"_level-primary_ujus9_145","level-secondary":"_level-secondary_ujus9_153","level-tertiary":"_level-tertiary_ujus9_161","level-danger":"_level-danger_ujus9_169",disabled:Ee,checkbox:Ve},z=({className:b,as:he="label",testId:h="Toggle",level:xe="primary",size:x="medium",onToggle:Ae=()=>null,disabled:A,children:Re,...je})=>{const[s,De]=_.useState(!1),R=_.useId(),j=_.useId(),Ne=()=>{De(!s),Ae()};return a.jsx(ke,{as:he,"data-testid":h,size:x,weight:"medium",className:D(r.this,{[r.disabled]:A},b),htmlFor:R,...je,children:a.jsxs(Ie,{as:"span",gutter:x,elevation:s?"large":"medium","data-testid":`${h}-inner`,className:D(r.inner,r[`level-${xe}`],{[r.toggled]:s}),children:[a.jsx("input",{className:r.checkbox,id:R,"aria-describedby":j,onClick:Ne,disabled:A,type:"checkbox"}),a.jsx(Pe,{icon:s?qe:Me}),a.jsx("span",{id:j,children:Re})]})})};z.displayName="Toggle";const Fe=z;z.__docgenInfo={description:"",methods:[],displayName:"Toggle",props:{className:{required:!1,tsType:{name:"string"},description:""},as:{required:!1,tsType:{name:"ReactElementType",raw:"React.ElementType"},description:"",defaultValue:{value:"'label'",computed:!1}},testId:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'Toggle'",computed:!1}},children:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""},htmlFor:{required:!1,tsType:{name:"string"},description:""},level:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary' | 'tertiary' | 'danger'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'tertiary'"},{name:"literal",value:"'danger'"}]},description:"",defaultValue:{value:"'primary'",computed:!1}},size:{required:!1,tsType:{name:"union",raw:"'none' | 'small' | 'medium' | 'large'",elements:[{name:"literal",value:"'none'"},{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'large'"}]},description:"",defaultValue:{value:"'medium'",computed:!1}},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"",defaultValue:{value:"() => null",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:""}}};const Qe={title:"Inputs/Toggle",component:Fe,decorators:[b=>a.jsx(we,{children:b()})]},e={as:"label",testId:"Toggle",level:"primary",size:"medium",disabled:!1,children:"Toggle Me"},l={args:{...e,size:"small"}},t={args:{...e,size:"medium"}},n={args:{...e,size:"large"}},o={args:{...e,disabled:!0}},i={args:{...e,level:"secondary",size:"small"}},d={args:{...e,level:"secondary",size:"medium"}},c={args:{...e,level:"secondary",size:"large"}},m={args:{...e,level:"secondary",disabled:!0}},u={args:{...e,level:"tertiary",size:"small"}},g={args:{...e,level:"tertiary",size:"medium"}},p={args:{...e,level:"tertiary",size:"large"}},y={args:{...e,level:"tertiary",disabled:!0}},v={args:{...e,level:"danger",size:"small"}},f={args:{...e,level:"danger",size:"medium"}},S={args:{...e,level:"danger",size:"large"}},T={args:{...e,level:"danger",disabled:!0}};var N,w,P;l.parameters={...l.parameters,docs:{...(N=l.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
    size: 'small'
  }
}`,...(P=(w=l.parameters)==null?void 0:w.docs)==null?void 0:P.source}}};var q,M,k;t.parameters={...t.parameters,docs:{...(q=t.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
    size: 'medium'
  }
}`,...(k=(M=t.parameters)==null?void 0:M.docs)==null?void 0:k.source}}};var I,L,C;n.parameters={...n.parameters,docs:{...(I=n.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
    size: 'large'
  }
}`,...(C=(L=n.parameters)==null?void 0:L.docs)==null?void 0:C.source}}};var E,V,F;o.parameters={...o.parameters,docs:{...(E=o.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
    disabled: true
  }
}`,...(F=(V=o.parameters)==null?void 0:V.docs)==null?void 0:F.source}}};var B,$,O;i.parameters={...i.parameters,docs:{...(B=i.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
    level: 'secondary',
    size: 'small'
  }
}`,...(O=($=i.parameters)==null?void 0:$.docs)==null?void 0:O.source}}};var X,G,H;d.parameters={...d.parameters,docs:{...(X=d.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
    level: 'secondary',
    size: 'medium'
  }
}`,...(H=(G=d.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};var J,K,Q;c.parameters={...c.parameters,docs:{...(J=c.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
    level: 'secondary',
    size: 'large'
